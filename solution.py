...
if __name__ == "__main__":
    ...
    print(welcome_assignment_answers(debug_question))
    debug_question = "What is the SHA1 hashing value to the following message: 'NYU Computer Networking' - Use SHA1 hash generator and use the answer in your code"
    print(welcome_assignment_answers(debug_question))
